const config = {
  development: {
    ...
    dbgnAddress: '0x4922fafB060C89E0B1A22339f3e52dA4f6e0f980',
...
console.log(
  ...
  config[envKey as keyof typeof config].contractAddress
);
console.log(
  'EURe address being used:',
  config[envKey as keyof typeof config].eureAddress
);
